...
> [!NOTE]
> Some technical info. For a video with frame rate = 30 we have 33 ms frame budget (usually rounded to 30). Theora is purely CPU decoder. Numbers are for my i9-10900 and for 1920x1080 video.
>
