...
Known issues
- interactive objects (like lever arms) don't move when player interacts (doesn't work in MP as well)
- some effects which don't exist in MP (such as strong wind) aren't implemented in rend2
